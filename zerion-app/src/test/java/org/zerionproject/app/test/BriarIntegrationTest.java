...
public abstract class BriarIntegrationTest<C extends BriarIntegrationTestComponent>
	...
	private void startLifecycles() throws InterruptedException {
		...
		assertEquals(SUCCESS, lifecycleManager0.startServices(getSecretKey()));
		assertEquals(SUCCESS, lifecycleManager1.startServices(getSecretKey()));
		assertEquals(SUCCESS, lifecycleManager2.startServices(getSecretKey()));
